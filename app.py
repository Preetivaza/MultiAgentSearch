...
if run_btn:
    if not topic.strip():
        ...
        st.session_state.pipeline_error = None  # Clear previous errors
        st.rerun()
...
if st.session_state.running and not st.session_state.done:
    ...
    try:
        ...
        import traceback
        st.session_state.pipeline_error = f"🚨 **An error occurred during the pipeline:** {str(e)}\n\n```python\n{traceback.format_exc()}\n```"
        st.session_state.running = False
        st.session_state.done = False
...
if getattr(st.session_state, "pipeline_error", None):
